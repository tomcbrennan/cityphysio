...
add_action('wp_enqueue_scripts', function () {
    wp_enqueue_script('tomdotcom-ajax', get_stylesheet_directory_uri() . '/ajax/ajax.js', array('jquery'), filemtime(get_stylesheet_directory() . '/ajax/ajax.js') );
    wp_localize_script('tomdotcom-ajax', 'sd_ajax', array('ajax_url' => admin_url('admin-ajax.php')));
});
